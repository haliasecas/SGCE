...
<?php
    ...
    if($row_cnt>0){
        ...
        echo '<script language="javascript" >alert("La cita ha pasado al estado de Pendiente");</script>'
    }
    else{
        echo '<script language="javascript" >alert("El token es incorrecto");</script>'; 
    }
    //echo $row_cnt;
