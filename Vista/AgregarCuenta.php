                ...
                <form action="" class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            ...
                            <input type='nombre' class='form-control' placeholder="Rodrigo">
                        </div>
                        <br>
                        <br>
                        <br>
                        ...
                        <div class="col-md-10">
                            <input type='apmaterno' class='form-control' placeholder="Perez">
                        ...
                        <div class="col-md-10">
                            ...
                            <input type='correo' class='form-control' placeholder="ejemplo@dominio.com">
                        </div>
                        <br>
                        <br>
                        <br>
                        ...
                        <br>
                        <br>
                        <label  for="" class="control-label col-md-2">Cargo</label>
                        <div class="col-md-10">                                        
                            <select name="departamento" class="form-control">
